...
@section('content')
            ...
            <section class="flat-title-page" style="background-image: url(images/page-title/page-title-3.jpg);">
                <div class="container">
                    <div class="breadcrumb-content">
                        ...
                        <h1 class="text-center text-white title">Frequently Asked Questions</h1>
                    </div>
                </div>
            </section>
            <!-- End Page Title -->
            ...
            <section class="flat-section">
                <div class="container">
                    <div class="tf-faq">
                        <h3 class="fw-8 text-center title">Overview</h3>
                    ...
                    <div class="tf-faq">
                        <h3 class="fw-8 text-center title">Costs and Payments</h3>
                        <ul class="box-faq" id="wrapper-faq-two">
                            ...
                            <li class="faq-item">
                                <a href="#accordion2-faq-three" class="faq-header collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion2-faq-three">
                                    Are there opportunities for discounts or promotions?
                                </a>
                                <div id="accordion2-faq-three" class="collapse" data-bs-parent="#wrapper-faq-two">
                                    <p class="faq-body">
                                        Once your account is set up and you've familiarized yourself with the platform, you are ready to start using our services. Whether it's accessing specific features, making transactions, or utilizing our tools, you'll find everything you need at your fingertips.
                                    </p>
                                </div>
                    ...
                    <div class="tf-faq">
                        <h3 class="fw-8 text-center title">Safety and Security</h3>
                        <ul class="box-faq" id="wrapper-faq-three">
                            ...
                            <li class="faq-item">
                                <a href="#accordion3-faq-three" class="faq-header collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion3-faq-three">
                                    What are the safety features of your system?
                                </a>
                                <div id="accordion3-faq-three" class="collapse" data-bs-parent="#wrapper-faq-three">
                                    <p class="faq-body">
                                        Once your account is set up and you've familiarized yourself with the platform, you are ready to start using our services. Whether it's accessing specific features, making transactions, or utilizing our tools, you'll find everything you need at your fingertips.
                                    </p>
                                </div>
                            ...
                            <li class="faq-item">
                                <a href="#accordion3-faq-four" class="faq-header collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion3-faq-four">
                            ...
                            <li class="faq-item">
                                <a href="#accordion3-faq-five" class="faq-header collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion3-faq-five">
                            ...
                            <li class="faq-item">
                                <a href="#accordion3-faq-six" class="faq-header collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion3-faq-six">
                                    How do I report a technical issue?
                                </a>
                                <div id="accordion3-faq-six" class="collapse" data-bs-parent="#wrapper-faq-three">
                                    <p class="faq-body">
                                        Once your account is set up and you've familiarized yourself with the platform, you are ready to start using our services. Whether it's accessing specific features, making transactions, or utilizing our tools, you'll find everything you need at your fingertips.
                                    </p>
                                </div>
