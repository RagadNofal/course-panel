<!-- resources/views/components/modals/register.blade.php -->
<div class="modal modal-account fade" id="modalRegister">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="flat-account">
                <div class="banner-account">
                    <img src="{{ asset('assets/images/banner/banner-account2.jpg') }}" alt="banner">
                </div>
                ...
                <div class="box">
                    ...
                    <div class="box box-btn">
                        <a href="{{ route('dashboard') }}" class="tf-btn primary w-100">Sign Up</a>
                        <div class="text text-center">
                            Don’t have an account?
                            <a href="#modalLogin" data-bs-toggle="modal" class="text-primary">Sign In</a>
                        </div>
                    </div>
                    <p class="box text-center caption-2">or login with</p>
                    <div class="group-btn">
                        <a href="#" class="btn-social">
                            <img src="{{ asset('assets/images/logo/google.jpg') }}" alt="img">
                            Google
                        </a>
                        <a href="#" class="btn-social">
                            <img src="{{ asset('assets/images/logo/fb.jpg') }}" alt="img">
                            Facebook
                        </a>
                    </div>
                </form>
